...
for color in ["blue", "red", "yellow"]:
    for state in ["down", "mid", "up"]:
        file = "games//sprites//" + color + "-" + state + ".png"
        var = "bird_" + color + "_" + state
        exec(var + load_cmd)
        exec(var + resize_cmd)

bg1 = pygame.image.load("games//sprites//day.png")
bg2 = pygame.image.load("games//sprites//night.png")
pipe_green_btm = pygame.image.load("games//sprites//pipe-green.png")
pipe_red_btm = pygame.image.load("games//sprites//pipe-red.png")
start = pygame.image.load("games//sprites//start.png")
gameover = pygame.image.load("games//sprites//gameover.png")
base = pygame.image.load("games//sprites//base.png")
